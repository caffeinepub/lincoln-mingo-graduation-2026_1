...
export interface _SERVICE {
  ...
  'addGuestBookMessage' : ActorMethod<[string, string], undefined>,
  'addMemory' : ActorMethod<[ExternalBlob, string, string], undefined>,
  ...
  'registerAdminBySecret' : ActorMethod<[string], boolean>,
