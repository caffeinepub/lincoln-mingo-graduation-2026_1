...
export class Backend implements backendInterface {
    ...
    async addGuestBookMessage(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addGuestBookMessage(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addMemory(arg0: ExternalBlob, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMemory(await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg0), arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllGuestBookMessages(): Promise<Array<GuestBookMessage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllGuestBookMessages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllMemories(): Promise<Array<MemoryMetadata>> {
        if (this.processError) {
            try {
    ...
    async getAllRSVPEntriesWithPin(pin: string): Promise<Array<RSVPEntry>> {
        if (this.processError) {
            try {
                const result = await (this.actor as any).getAllRSVPEntriesWithPin(pin);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePhoto(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePhoto();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_MemoryMetadata_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MemoryMetadata): Promise<MemoryMetadata> {
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MemoryMetadata>): Promise<Array<MemoryMetadata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MemoryMetadata_n12(_uploadFile, _downloadFile, x)));
}
